 ...
 *
 * Staff views feedback options
 *
 * Generated from: specs/feedback-submission.yaml
 * Priority: p1
 */
...
const narrator = createNarrator("feedback-submission");
...
test.describe("Feedback Submission Flow", () => {
  ...
  test("feedback-submission: Staff views feedback options", async ({
    staffPage,
  }) => {
    ...
    // ═══════════════════════════════════════════════════════════════
    // STEP 2: Staff views their stats
    // Role: STAFF
    // ═══════════════════════════════════════════════════════════════
    const step2Duration = await narrator.step(2);
    logger.stepStart(2, "Staff views their stats");
    logger.log({ type: "action", description: "Role: STAFF", status: "info" });
