 ...
 * Offline Sync Flow
 *
 * Staff behavior logging supports offline mode
 *
 * Generated from: specs/offline-sync.yaml
 * Priority: p1
 */
...
const narrator = createNarrator("offline-sync");
...
test.describe("Offline Sync Flow", () => {
  ...
  test("offline-sync: Staff behavior logging supports offline mode", async ({
    staffPage,
  }) => {
    ...
    // ═══════════════════════════════════════════════════════════════
    // STEP 2: Staff sees behavior logging buttons
    // Role: STAFF
    // ═══════════════════════════════════════════════════════════════
    const step2Duration = await narrator.step(2);
    logger.stepStart(2, "Staff sees behavior logging buttons");
    logger.log({ type: "action", description: "Role: STAFF", status: "info" });
